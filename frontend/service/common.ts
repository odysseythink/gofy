...
export const fetchOdysseythinkVersion = ({ url, params }: { url: string, params: Record<string, any> }): Promise<OdysseythinkVersionResponse> => {
  return get<OdysseythinkVersionResponse>(url, { params })
}
