...
var (
	VARIABLE_TO_PARAMETER_TYPE_MAPPING = map[appconfigenumtypes.VariableEntityType]toolsenumtypes.ToolParameterType{
		appconfigenumtypes.VariableEntity_TEXT_INPUT: toolsenumtypes.ToolParameter_STRING,
		appconfigenumtypes.VariableEntity_PARAGRAPH:  toolsenumtypes.ToolParameter_STRING,
		appconfigenumtypes.VariableEntity_SELECT:     toolsenumtypes.ToolParameter_SELECT,
		appconfigenumtypes.VariableEntity_NUMBER:     toolsenumtypes.ToolParameter_NUMBER,
		appconfigenumtypes.VariableEntity_FILE:       toolsenumtypes.ToolParameter_FILE,
		appconfigenumtypes.VariableEntity_FILE_LIST:  toolsenumtypes.ToolParameter_FILES,
	}
)

type WorkflowToolProviderController struct {
...
//         features = WorkflowAppConfigManage.convert_features(config_dict=features_dict, app_mode=AppMode.WORKFLOW)
