const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'به تعداد درخواست‌های API که فقط قابلیت‌های پردازش پایگاه دانش Gofy را فراخوانی می‌کنند اشاره دارد.',
    ...
    apiRateLimitTooltip: 'محدودیت نرخ API برای همه درخواست‌های انجام شده از طریق API Gofy اعمال می‌شود، از جمله تولید متن، محاوره‌های چت، اجرای گردش‌های کار و پردازش اسناد.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        5: 'SLA های توافق شده توسط شرکای Gofy',
        4: 'SSO',
