const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Gofy\'nin sadece bilgi tabanı işleme yeteneklerini çağıran API çağrıları sayısını ifade eder.',
    ...
    apiRateLimitTooltip: 'Gofy API\'si aracılığıyla yapılan tüm isteklerde, metin oluşturma, sohbet konuşmaları, iş akışı yürütmeleri ve belge işleme dahil olmak üzere, API Oran Sınırı uygulanır.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        7: 'Gofy Tarafından Resmi Güncellemeler ve Bakım',
        5: 'Gofy Ortakları tarafından müzakere edilen SLA\'lar',
    ...
    community: {
      features: {
        ...
        2: 'Gofy Açık Kaynak Lisansına uyar',
      },
      price: 'Ücretsiz',
