...
// ToChromaParams 等价于 Python 的 to_chroma_params
func (cfg *ChromaConfig) ToChromaParams() map[string]interface{} {
    settings := make(map[string]string)
	if cfg.AuthProvider != nil {
		settings["chroma_client_auth_provider"] = c.AuthProvider
	}
	if cfg.AuthCredentials != nil {
		settings["chroma_client_auth_credentials"] = c.AuthCredentials
	}
