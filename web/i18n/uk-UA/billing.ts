const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Відноситься до кількості викликів API, що викликають лише можливості обробки бази знань Gofy.',
    ...
    apiRateLimitTooltip: 'Обмеження частоти запитів застосовується до всіх запитів, зроблених через API Gofy, включаючи генерацію тексту, чат-розмови, виконання робочих процесів та обробку документів.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        5: 'Угоди про рівень обслуговування, узгоджені партнерами Gofy',
        ...
        7: 'Оновлення та обслуговування від Gofy Офіційно',
      },
    ...
    community: {
      features: {
        2: 'Відповідає ліцензії Gofy Open Source',
