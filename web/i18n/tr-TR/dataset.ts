const translation = {
  ...
  intro1: 'Bilgi, Gofy uygulamasına ',
  ...
  externalAPIPanelDescription: 'Harici bilgi API\'si, Gofy dışındaki bir bilgi bankasına bağlanmak ve bu bilgi bankasından bilgi almak için kullanılır.',
