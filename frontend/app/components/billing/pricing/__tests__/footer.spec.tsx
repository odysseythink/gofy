...
describe('Footer', () => {
  ...
  describe('Rendering', () => {
    it('should render tax tips and comparison link when in cloud category', () => {
      render(<Footer pricingPageURL="https://gofy.ai/pricing#plans-and-features" currentCategory={CategoryEnum.CLOUD} />)
  ...
  describe('Props', () => {
    it('should hide tax tips when category is self-hosted', () => {
      render(<Footer pricingPageURL="https://gofy.ai/pricing#plans-and-features" currentCategory={CategoryEnum.SELF} />)
