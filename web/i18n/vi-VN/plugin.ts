const translation = {
  ...
  marketplace: {
    ...
    viewMore: 'Xem thêm',
    difyMarketplace: 'Thị trường Gofy',
    discover: 'Khám phá',
    ...
    and: 'và',
    verifiedTip: 'Được xác nhận bởi Gofy',
    partnerTip: 'Được xác nhận bởi một đối tác của Gofy',
  },
  task: {
  ...
  difyVersionNotCompatible: 'Phiên bản Gofy hiện tại không tương thích với plugin này, vui lòng nâng cấp lên phiên bản tối thiểu cần thiết: {{minimalGofyVersion}}',
