const translation = {
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Gofy to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Gofy allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Gofy\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Gofy {{version}} is now available.',
    latestAvailable: 'Gofy {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
