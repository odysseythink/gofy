const translation = {
  ...
  marketplace: {
    ...
    viewMore: 'View more',
    verifiedTip: 'Verified by Gofy',
    partnerTip: 'Verified by a Gofy partner',
  },
  task: {
  ...
  difyVersionNotCompatible: 'The current Gofy version is not compatible with this plugin, please upgrade to the minimum version required: {{minimalGofyVersion}}',
  auth: {
    default: 'Default',
    custom: 'Custom',
