const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Đề cập đến số lượng cuộc gọi API triệu hồi chỉ khả năng xử lý cơ sở kiến thức của Gofy.',
    ...
    apiRateLimitTooltip: 'Giới hạn tần suất API áp dụng cho tất cả các yêu cầu được thực hiện thông qua API Gofy, bao gồm tạo văn bản, cuộc trò chuyện, thực thi quy trình làm việc và xử lý tài liệu.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        7: 'Cập nhật và Bảo trì bởi Gofy Chính thức',
        5: 'Thỏa thuận SLA bởi các đối tác Gofy',
    ...
    community: {
      features: {
        2: 'Tuân thủ Giấy phép Mã nguồn Mở Gofy',
