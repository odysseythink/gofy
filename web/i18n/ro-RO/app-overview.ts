const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Sau încercați versiunea cloud a Gofy cu cotă gratuită',
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajută vizitatorii să înțeleagă datele pe care le colectează aplicația, consultați <privacyPolicyLink>Politica de confidențialitate</privacyPolicyLink> a Gofy.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalați extensia Chrome Gofy Chatbot',
        copied: 'Copiat',
        copy: 'Copiați',
      },
      qrcode: {
