...
describe('RetrievalSection', () => {
  ...
  it('renders internal retrieval config with doc link', () => {
    ...
    expect(learnMoreLink).toHaveAttribute('href', 'https://docs.example/use-gofy/knowledge/create-knowledge/setting-indexing-methods')
    expect(docLink).toHaveBeenCalledWith('/use-gofy/knowledge/create-knowledge/setting-indexing-methods')
  })
