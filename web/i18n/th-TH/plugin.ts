const translation = {
  ...
  marketplace: {
    ...
    difyMarketplace: 'ตลาด Gofy',
    partnerTip: 'ได้รับการตรวจสอบโดยพันธมิตรของ Gofy',
    verifiedTip: 'ได้รับการตรวจสอบโดย Gofy',
  },
  task: {
  ...
  difyVersionNotCompatible: 'เวอร์ชั่นปัจจุบันของ Gofy ไม่สามารถใช้งานร่วมกับปลั๊กอินนี้ได้ กรุณาอัปเกรดไปยังเวอร์ชั่นขั้นต่ำที่ต้องการ: {{minimalGofyVersion}}',
