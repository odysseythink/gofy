const translation = {
  ...
  intro1: 'Wiedzę można zintegrować z aplikacją Gofy ',
  ...
  externalAPIPanelDescription: 'Interfejs API wiedzy zewnętrznej służy do łączenia się z bazą wiedzy poza Gofy i pobierania wiedzy z tej bazy wiedzy.',
  chunkingMode: {
