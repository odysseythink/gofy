    ...
    <div className={cn(labelClass, 'w-auto min-w-[168px]')}>
      <div>
        ...
        <div className="text-xs font-normal leading-[18px] text-text-tertiary">
          <a target="_blank" rel="noopener noreferrer" href={docLink('/use-gofy/knowledge/create-knowledge/setting-indexing-methods')} className="text-text-accent">{t('form.retrievalSetting.learnMore', { ns: 'datasetSettings' })}</a>
