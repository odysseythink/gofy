const translation = {
  ...
  welcome: 'Willkommen bei Gofy, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit Gofy Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf Gofy beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'Gofy erkunden',
  ...
  resetPasswordDesc: 'Geben Sie die E-Mail-Adresse ein, mit der Sie sich bei Gofy angemeldet haben, und wir senden Ihnen eine E-Mail zum Zurücksetzen des Passworts.',
  ...
  licenseLostTip: 'Fehler beim Verbinden des Gofy-Lizenzservers. Wenden Sie sich an Ihren Administrator, um Gofy weiterhin zu verwenden.',
  licenseInactive: 'Lizenz inaktiv',
  licenseInactiveTip: 'Die Gofy Enterprise-Lizenz für Ihren Arbeitsbereich ist inaktiv. Wenden Sie sich an Ihren Administrator, um Gofy weiterhin zu verwenden.',
  licenseExpiredTip: 'Die Gofy Enterprise-Lizenz für Ihren Arbeitsbereich ist abgelaufen. Wenden Sie sich an Ihren Administrator, um Gofy weiterhin zu verwenden.',
