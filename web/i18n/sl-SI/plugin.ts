const translation = {
  ...
  marketplace: {
    ...
    sortBy: 'Razvrsti po',
    verifiedTip: 'Verificirano s strani Gofy',
    discover: 'Odkrijte',
    partnerTip: 'Potrjeno s strani partnerja Gofy',
    ...
    difyMarketplace: 'Gofy Marketplace',
  },
  task: {
  ...
  difyVersionNotCompatible: 'Trenutna različica Gofy ni združljiva s to vtičnico, prosimo, posodobite na minimalno zahtevano različico: {{minimalGofyVersion}}',
