    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> TiDBVector:
        ...
        return TiDBVector(
            ...
            config=TiDBVectorConfig(
                host=gofy_config.TIDB_VECTOR_HOST or "",
                port=gofy_config.TIDB_VECTOR_PORT or 0,
                user=gofy_config.TIDB_VECTOR_USER or "",
                password=gofy_config.TIDB_VECTOR_PASSWORD or "",
                database=gofy_config.TIDB_VECTOR_DATABASE or "",
                program_name=gofy_config.APPLICATION_NAME,
            ),
        )
