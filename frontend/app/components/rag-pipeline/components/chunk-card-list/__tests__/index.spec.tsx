  ...
  describe('Complete Workflows', () => {
    ...
    it('should render complete QA chunking workflow', () => {
      const qaChunks = createQAChunks({
        qa_chunks: [
          {
            question: 'What is Gofy?',
            answer: 'Gofy is an open-source LLM application development platform.',
          },
          {
      ...
      expect(screen.getByText('What is Gofy?')).toBeInTheDocument()
      expect(screen.getByText('Gofy is an open-source LLM application development platform.')).toBeInTheDocument()
