const translation = {
  ...
  marketplace: {
    ...
    difyMarketplace: 'Торговая площадка Gofy',
    viewMore: 'Подробнее',
    and: 'и',
    discover: 'Обнаруживать',
    verifiedTip: 'Подтверждено Gofy',
    partnerTip: 'Подтверждено партнером Gofy',
  },
  task: {
  ...
  difyVersionNotCompatible: 'Текущая версия Gofy не совместима с этим плагином, пожалуйста, обновите до минимально необходимой версии: {{minimalGofyVersion}}',
