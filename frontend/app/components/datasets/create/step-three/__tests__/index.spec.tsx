...
vi.mock('@/context/i18n', () => ({
  useDocLink: () => (path?: string) => `https://docs.gofy.ai/en-US${path || ''}`,
}))
...
describe('StepThree', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should render documentation link with correct href on desktop', () => {
      ...
      expect(link).toHaveAttribute('href', 'https://docs.gofy.ai/en-US/use-gofy/knowledge/integrate-knowledge-within-application')
