const translation = {
  ...
  marketplace: {
    ...
    difyMarketplace: 'Mercado Gofy',
    moreFrom: 'Mais do Marketplace',
    noPluginFound: 'Nenhum plugin encontrado',
    discover: 'Descobrir',
    verifiedTip: 'Verificado pelo Gofy',
    partnerTip: 'Verificado por um parceiro da Gofy',
  },
  task: {
  ...
  difyVersionNotCompatible: 'A versão atual do Gofy não é compatível com este plugin, por favor atualize para a versão mínima exigida: {{minimalGofyVersion}}',
