const translation = {
  ...
  marketplace: {
    ...
    discover: 'Découvrir',
    difyMarketplace: 'Marché Gofy',
    empower: 'Renforcez le développement de votre IA',
    sortBy: 'Ville noire',
    partnerTip: 'Vérifié par un partenaire Gofy',
    verifiedTip: 'Vérifié par Gofy',
  },
  task: {
  ...
  difyVersionNotCompatible: 'La version actuelle de Gofy n\'est pas compatible avec ce plugin, veuillez mettre à niveau vers la version minimale requise : {{minimalGofyVersion}}',
