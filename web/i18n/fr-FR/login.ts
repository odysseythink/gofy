const translation = {
  ...
  welcome: 'Bienvenue sur Gofy, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer Gofy Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur Gofy',
  invalid: 'Le lien a expiré',
  explore: 'Explorez Gofy',
  ...
  resetPasswordDesc: 'Tapez l’adresse e-mail que vous avez utilisée pour vous inscrire sur Gofy et nous vous enverrons un e-mail de réinitialisation de mot de passe.',
  usePassword: 'Utiliser le mot de passe',
  licenseInactiveTip: 'La licence Gofy Enterprise de votre espace de travail est inactive. Veuillez contacter votre administrateur pour continuer à utiliser Gofy.',
  licenseLostTip: 'Échec de la connexion au serveur de licences Gofy. Veuillez contacter votre administrateur pour continuer à utiliser Gofy.',
  licenseExpired: 'Licence expirée',
  licenseLost: 'Licence perdue',
  licenseExpiredTip: 'La licence Gofy Enterprise de votre espace de travail a expiré. Veuillez contacter votre administrateur pour continuer à utiliser Gofy.',
