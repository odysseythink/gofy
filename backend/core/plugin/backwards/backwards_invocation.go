...
// NewGofyInvocation creates a new backwards invocation handler.
func NewGofyInvocation(tenantID, userID, appID string) *GofyInvocation {
	return &GofyInvocation{
		tenantID: tenantID,
		userID:   userID,
		appID:    appID,
...
func (di *GofyInvocation) SetContext(ctx context.Context) {
	di.ctx = ctx
}

// Context returns the current context.
func (di *GofyInvocation) Context() context.Context {
	if di.ctx == nil {
...
func (di *GofyInvocation) getModelInstance(provider string, modelType modelruntimeenumtypes.ModelType, model string) (mi *modelmanager.ModelInstance, err error) {
	defer func() {
		if r := recover(); r != nil {
...
func (di *GofyInvocation) InvokeLLM(payload any) (<-chan any, error) {
...
func (di *GofyInvocation) InvokeLLMWithStructuredOutput(payload any) (<-chan any, error) {
	params, err := payloadToMap(payload)
	if err != nil {
...
func (di *GofyInvocation) InvokeTextEmbedding(payload any) (any, error) {
	params, err := payloadToMap(payload)
	if err != nil {
...
func (di *GofyInvocation) InvokeMultimodalEmbedding(payload any) (any, error) {
...
func (di *GofyInvocation) InvokeRerank(payload any) (any, error) {
	params, err := payloadToMap(payload)
	if err != nil {
...
func (di *GofyInvocation) InvokeMultimodalRerank(payload any) (any, error) {
...
func (di *GofyInvocation) InvokeTTS(payload any) (<-chan any, error) {
	params, err := payloadToMap(payload)
	if err != nil {
...
func (di *GofyInvocation) InvokeSpeech2Text(payload any) (any, error) {
	params, err := payloadToMap(payload)
	if err != nil {
...
func (di *GofyInvocation) InvokeModeration(payload any) (any, error) {
	params, err := payloadToMap(payload)
	if err != nil {
...
func (di *GofyInvocation) InvokeTool(payload any) (<-chan plugin.ToolResponseChunk, error) {
	params, err := payloadToMap(payload)
	if err != nil {
	...
	ch := make(chan plugin.ToolResponseChunk, 50)
	...
	go func() {
		...
		defer func() {
			if r := recover(); r != nil {
				...
				ch <- plugin.ToolResponseChunk{
					Type:    plugin.ToolResponseChunkTypeText,
...
// toolInvokeMessageToChunk converts a ToolInvokeMessage to a plugin.ToolResponseChunk.
func toolInvokeMessageToChunk(msg *toolsentities.ToolInvokeMessage) plugin.ToolResponseChunk {
	return plugin.ToolResponseChunk{
		Type:    plugin.ToolResponseChunkType(msg.Type),
		Message: msg.ToDict(),
		Meta:    msg.Meta,
	}
}
...
// InvokeApp calls another Gofy app via the app generation service.
func (di *GofyInvocation) InvokeApp(payload any) (<-chan map[string]any, error) {
	params, err := payloadToMap(payload)
	if err != nil {
...
func (di *GofyInvocation) InvokeParameterExtractor(payload any) (*plugin.InvokeNodeResponse, error) {
	params, err := payloadToMap(payload)
	if err != nil {
	...
	return &plugin.InvokeNodeResponse{
		Outputs: outputs,
...
func (di *GofyInvocation) InvokeQuestionClassifier(payload any) (*plugin.InvokeNodeResponse, error) {
	params, err := payloadToMap(payload)
	if err != nil {
...
func (di *GofyInvocation) InvokeEncrypt(payload any) (map[string]any, error) {
	params, err := payloadToMap(payload)
	if err != nil {
...
func (di *GofyInvocation) InvokeSummary(payload any) (*plugin.InvokeSummaryResponse, error) {
	params, err := payloadToMap(payload)
	if err != nil {
	...
	return &plugin.InvokeSummaryResponse{Summary: summary}, nil
}
...
func (di *GofyInvocation) UploadFile(payload any) (*plugin.UploadFileResponse, error) {
	params, err := payloadToMap(payload)
	if err != nil {
	...
	return &plugin.UploadFileResponse{URL: uploadFile.Key}, nil
}
...
func (di *GofyInvocation) FetchApp(payload any) (map[string]any, error) {
