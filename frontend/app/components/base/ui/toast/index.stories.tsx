...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Gofy toast host built on Base UI Toast. The story is organized as multiple example panels that all feed the same shared toast viewport, matching the way the Base UI documentation showcases toast behavior.',
      },
    },
  },
  tags: ['autodocs'],
