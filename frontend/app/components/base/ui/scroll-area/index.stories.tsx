...
export const VerticalPanels: Story = {
  render: () => (
    <StoryCard
      ...
      description="Two common Gofy surfaces: a straightforward content panel using the shipped scrollbar skin, and a denser queue pane that adds sticky structure, a viewport mask, and a slightly inset scrollbar."
    >
