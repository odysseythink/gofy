const translation = {
  ...
  intro1: 'دانش می‌تواند در برنامه Gofy ',
  ...
  externalAPIPanelDescription: 'API دانش خارجی برای اتصال به یک پایگاه دانش خارج از Gofy و بازیابی دانش از آن پایگاه دانش استفاده می شود.',
