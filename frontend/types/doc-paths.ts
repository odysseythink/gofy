...
// UseGofy paths
export type UseGofyPath =
  | '/use-gofy/build/additional-features'
  | '/use-gofy/build/goto-anything'
  | '/use-gofy/build/mcp'
  | '/use-gofy/build/orchestrate-node'
  | '/use-gofy/build/predefined-error-handling-logic'
  | '/use-gofy/build/shortcut-key'
  | '/use-gofy/build/version-control'
  | '/use-gofy/debug/error-type'
  | '/use-gofy/debug/history-and-logs'
  | '/use-gofy/debug/step-run'
  | '/use-gofy/debug/variable-inspect'
  | '/use-gofy/getting-started/introduction'
  | '/use-gofy/getting-started/key-concepts'
  | '/use-gofy/getting-started/quick-start'
  | '/use-gofy/knowledge/connect-external-knowledge-base'
  | '/use-gofy/knowledge/create-knowledge/chunking-and-cleaning-text'
  | '/use-gofy/knowledge/create-knowledge/import-text-data/readme'
  | '/use-gofy/knowledge/create-knowledge/import-text-data/sync-from-notion'
  | '/use-gofy/knowledge/create-knowledge/import-text-data/sync-from-website'
  | '/use-gofy/knowledge/create-knowledge/introduction'
  | '/use-gofy/knowledge/create-knowledge/setting-indexing-methods'
  | '/use-gofy/knowledge/external-knowledge-api'
  | '/use-gofy/knowledge/integrate-knowledge-within-application'
  | '/use-gofy/knowledge/knowledge-pipeline/authorize-data-source'
  | '/use-gofy/knowledge/knowledge-pipeline/create-knowledge-pipeline'
  | '/use-gofy/knowledge/knowledge-pipeline/knowledge-pipeline-orchestration'
  | '/use-gofy/knowledge/knowledge-pipeline/manage-knowledge-base'
  | '/use-gofy/knowledge/knowledge-pipeline/publish-knowledge-pipeline'
  | '/use-gofy/knowledge/knowledge-pipeline/readme'
  | '/use-gofy/knowledge/knowledge-pipeline/upload-files'
  | '/use-gofy/knowledge/knowledge-request-rate-limit'
  | '/use-gofy/knowledge/manage-knowledge/introduction'
  | '/use-gofy/knowledge/manage-knowledge/maintain-dataset-via-api'
  | '/use-gofy/knowledge/manage-knowledge/maintain-knowledge-documents'
  | '/use-gofy/knowledge/metadata'
  | '/use-gofy/knowledge/readme'
  | '/use-gofy/knowledge/test-retrieval'
  | '/use-gofy/monitor/analysis'
  | '/use-gofy/monitor/annotation-reply'
  | '/use-gofy/monitor/integrations/integrate-aliyun'
  | '/use-gofy/monitor/integrations/integrate-arize'
  | '/use-gofy/monitor/integrations/integrate-langfuse'
  | '/use-gofy/monitor/integrations/integrate-langsmith'
  | '/use-gofy/monitor/integrations/integrate-opik'
  | '/use-gofy/monitor/integrations/integrate-phoenix'
  | '/use-gofy/monitor/integrations/integrate-weave'
  | '/use-gofy/monitor/logs'
  | '/use-gofy/nodes/agent'
  | '/use-gofy/nodes/answer'
  | '/use-gofy/nodes/code'
  | '/use-gofy/nodes/doc-extractor'
  | '/use-gofy/nodes/http-request'
  | '/use-gofy/nodes/human-input'
  | '/use-gofy/nodes/ifelse'
  | '/use-gofy/nodes/iteration'
  | '/use-gofy/nodes/knowledge-retrieval'
  | '/use-gofy/nodes/list-operator'
  | '/use-gofy/nodes/llm'
  | '/use-gofy/nodes/loop'
  | '/use-gofy/nodes/output'
  | '/use-gofy/nodes/parameter-extractor'
  | '/use-gofy/nodes/question-classifier'
  | '/use-gofy/nodes/template'
  | '/use-gofy/nodes/tools'
  | '/use-gofy/nodes/trigger/overview'
  | '/use-gofy/nodes/trigger/plugin-trigger'
  | '/use-gofy/nodes/trigger/schedule-trigger'
  | '/use-gofy/nodes/trigger/webhook-trigger'
  | '/use-gofy/nodes/user-input'
  | '/use-gofy/nodes/variable-aggregator'
  | '/use-gofy/nodes/variable-assigner'
  | '/use-gofy/publish/README'
  | '/use-gofy/publish/developing-with-apis'
  | '/use-gofy/publish/publish-mcp'
  | '/use-gofy/publish/publish-to-marketplace'
  | '/use-gofy/publish/webapp/chatflow-webapp'
  | '/use-gofy/publish/webapp/embedding-in-websites'
  | '/use-gofy/publish/webapp/web-app-access'
  | '/use-gofy/publish/webapp/web-app-settings'
  | '/use-gofy/publish/webapp/workflow-webapp'
  | '/use-gofy/tutorials/article-reader'
  | '/use-gofy/tutorials/build-ai-image-generation-app'
  | '/use-gofy/tutorials/customer-service-bot'
  | '/use-gofy/tutorials/simple-chatbot'
  | '/use-gofy/tutorials/twitter-chatflow'
  | '/use-gofy/tutorials/workflow-101/lesson-01'
  | '/use-gofy/tutorials/workflow-101/lesson-02'
  | '/use-gofy/tutorials/workflow-101/lesson-03'
  | '/use-gofy/tutorials/workflow-101/lesson-04'
  | '/use-gofy/tutorials/workflow-101/lesson-05'
  | '/use-gofy/tutorials/workflow-101/lesson-06'
  | '/use-gofy/tutorials/workflow-101/lesson-07'
  | '/use-gofy/tutorials/workflow-101/lesson-08'
  | '/use-gofy/tutorials/workflow-101/lesson-09'
  | '/use-gofy/tutorials/workflow-101/lesson-10'
  | '/use-gofy/workspace/api-extension/api-extension'
  | '/use-gofy/workspace/api-extension/cloudflare-worker'
  | '/use-gofy/workspace/api-extension/external-data-tool-api-extension'
  | '/use-gofy/workspace/api-extension/moderation-api-extension'
  | '/use-gofy/workspace/app-management'
  | '/use-gofy/workspace/model-providers'
  | '/use-gofy/workspace/personal-account-management'
  | '/use-gofy/workspace/plugins'
  | '/use-gofy/workspace/readme'
  | '/use-gofy/workspace/subscription-management'
  | '/use-gofy/workspace/team-members-management'

// UseGofy node paths (without prefix)
type ExtractNodesPath<T> = T extends `/use-gofy/nodes/${infer Path}` ? Path : never
export type UseGofyNodesPath = ExtractNodesPath<UseGofyPath>
...
export type SelfHostPath =
  ...
  | '/self-host/platform-guides/gofy-premium'
...
export type DevelopPluginPath =
  ...
  | '/develop-plugin/getting-started/getting-started-gofy-plugin'
  ...
  | '/develop-plugin/publishing/marketplace-listing/release-to-gofy-marketplace'
...
export type GofyDocPath = `${DocLanguage}/${DocPathWithoutLang}`
