const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Konto Gofy',
    langGeniusAccountTip: 'Twoje konto Gofy i powiązane dane użytkownika.',
  ...
  members: {
    ...
    invitationSentTip:
      'Zaproszenie zostało wysłane, a oni mogą zalogować się do Gofy, aby uzyskać dostęp do danych Twojego zespołu.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Usługa hostowania OpenAI dostarczana przez Gofy pozwala korzystać z modeli takich jak GPT-3.5. Przed wyczerpaniem limitu próbnego należy skonfigurować inne dostawców modeli.',
  ...
  apiBasedExtension: {
    title:
      'Rozszerzenia oparte na interfejsie API zapewniają scentralizowane zarządzanie interfejsami API, upraszczając konfigurację dla łatwego użytkowania w aplikacjach Gofy.',
  ...
  about: {
    ...
    nowAvailable: 'Gofy {{version}} jest teraz dostępny.',
    latestAvailable: 'Gofy {{version}} jest najnowszą dostępną wersją.',
  },
  appMenus: {
