          ...
          <div className="flex w-full max-w-[640px] grow flex-col items-center gap-4 pb-8 pt-6">
            <div className="relative flex flex-col items-center gap-[2px] self-stretch py-2">
              ...
              <p className="system-sm-regular text-text-tertiary">
                ...
                <a className="system-sm-regular self-stretch text-text-accent" href={docLink('/use-gofy/knowledge/connect-external-knowledge-base')} target="_blank" rel="noopener noreferrer">
