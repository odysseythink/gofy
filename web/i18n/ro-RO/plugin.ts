const translation = {
  ...
  marketplace: {
    ...
    difyMarketplace: 'Piața Gofy',
    moreFrom: 'Mai multe din Marketplace',
    and: 'și',
    viewMore: 'Vezi mai mult',
    partnerTip: 'Verificat de un partener Gofy',
    verifiedTip: 'Verificat de Gofy',
  },
  task: {
  ...
  difyVersionNotCompatible: 'Versiunea curentă Gofy nu este compatibilă cu acest plugin, vă rugăm să faceți upgrade la versiunea minimă necesară: {{minimalGofyVersion}}',
