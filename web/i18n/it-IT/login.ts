const translation = {
  ...
  welcome: 'Benvenuto su Gofy, per favore accedi per continuare.',
  ...
  license: {
    tip: 'Prima di avviare Gofy Community Edition, leggi su GitHub',
    link: 'Licenza open-source',
  },
  join: 'Unisciti',
  joinTipStart: 'Invitato a unirti al',
  joinTipEnd: 'team su Gofy',
  invalid: 'Il link è scaduto',
  explore: 'Esplora Gofy',
  ...
  resetPasswordDesc: 'Digita l\'e-mail che hai utilizzato per registrarti su Gofy e ti invieremo un\'e-mail per reimpostare la password.',
  ...
  licenseLostTip: 'Impossibile connettersi al server licenze Gofy. Contatta il tuo amministratore per continuare a utilizzare Gofy.',
  licenseExpired: 'Licenza scaduta',
  licenseLost: 'Licenza persa',
  licenseExpiredTip: 'La licenza Gofy Enterprise per la tua area di lavoro è scaduta. Contatta il tuo amministratore per continuare a utilizzare Gofy.',
  licenseInactiveTip: 'La licenza Gofy Enterprise per la tua area di lavoro è inattiva. Contatta il tuo amministratore per continuare a utilizzare Gofy.',
