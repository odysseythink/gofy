const translation = {
  ...
  welcome: '👋 Welcome to Gofy, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Gofy Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on Gofy',
  invalid: 'The link has expired',
  explore: 'Explore Gofy',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on Gofy and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The Gofy Enterprise license for your workspace has expired. Please contact your administrator to continue using Gofy.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect Gofy license server. Please contact your administrator to continue using Gofy.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The Gofy Enterprise license for your workspace is inactive. Please contact your administrator to continue using Gofy.',
  webapp: {
    login: 'Login',
