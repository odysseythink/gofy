    ...
    <div data-testid="indexing-section">
      {!!currentDataset?.doc_form && (
        <>
          ...
          <a href="https://docs.gofy.ai/use-gofy/knowledge/create-knowledge/chunking-and-cleaning-text">
      ...
      {currentDataset?.provider !== 'external' && indexMethod && (
        <>
          ...
          <a href="https://docs.gofy.ai/use-gofy/knowledge/create-knowledge/setting-indexing-methods">
