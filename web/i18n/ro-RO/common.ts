const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Cont Gofy',
    langGeniusAccountTip: 'Contul Gofy și datele de utilizator asociate.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitația a fost trimisă și pot să se autentifice în Gofy pentru a accesa datele echipei dvs.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Serviciul de găzduire OpenAI furnizat de Gofy vă permite să utilizați modele precum GPT-3.5. Înainte ca cota de probă să fie epuizată, trebuie să configurați alți furnizori de modele.',
      callTimes: 'Apeluri',
  ...
  apiBasedExtension: {
    title: 'Extensiile bazate pe API oferă o gestionare centralizată a API-urilor, simplificând configurația pentru o utilizare ușoară în aplicațiile Gofy.',
  ...
  about: {
    ...
    nowAvailable: 'Gofy {{version}} este acum disponibil.',
    latestAvailable: 'Gofy {{version}} este ultima versiune disponibilă.',
  },
  appMenus: {
