const translation = {
  ...
  welcome: 'Gofy\'ye hoş geldiniz, devam etmek için lütfen giriş yapın.',
  ...
  license: {
    tip: 'Gofy Community Edition\'ı başlatmadan önce GitHub\'daki',
  ...
  resetPasswordDesc: 'Gofy\'a kaydolmak için kullandığınız e-postayı yazın, size bir şifre sıfırlama e-postası gönderelim.',
  ...
  back: 'Geri',
  licenseExpiredTip: 'Çalışma alanınız için Gofy Enterprise lisansının süresi doldu. Gofy\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseLostTip: 'Gofy lisans sunucusuna bağlanılamadı. Gofy\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseInactiveTip: 'Çalışma alanınız için Gofy Enterprise lisansı etkin değil. Gofy\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
