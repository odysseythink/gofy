...
describe('VariableInspect Empty', () => {
  ...
  it('should render the empty-state copy and docs link', () => {
    ...
    expect(link).toHaveAttribute('href', resolveDocLink('/use-gofy/debug/variable-inspect'))
    expect(link).toHaveAttribute('target', '_blank')
    expect(mockDocLink).toHaveBeenCalledWith('/use-gofy/debug/variable-inspect')
  })
})
