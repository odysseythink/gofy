const translation = {
  ...
  marketplace: {
    ...
    verifiedTip: 'Перевірено Gofy',
    partnerTip: 'Перевірено партнером Gofy',
  },
  task: {
  ...
  difyVersionNotCompatible: 'Поточна версія Gofy не сумісна з цим плагіном, будь ласка, оновіть до мінімальної версії: {{minimalGofyVersion}}',
